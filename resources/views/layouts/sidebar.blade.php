      ...
      <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        ...
        @if(Auth::user()->role_id == 1) 
          <li class="mt-0.5 w-full">
            <a href="{{route('adminList')}}" class="py-2.7 bg-blue-500/13 dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors">
            ...
            <li class="mt-0.5 w-full">
              <a href="{{route('adminCreate')}}" class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/tables.html">
                ...
                <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Panitia</span>
              </a>
            </li>
        @endif
