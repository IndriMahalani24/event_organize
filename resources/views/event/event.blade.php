      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <img src="{{asset('../assets/img/speakers/speaker-3.jpg')}}" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="member">
              <img src="{{asset('../assets/img/speakers/speaker-4.jpg')}}" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
        ...
        <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{asset('../assets/img/speakers/speaker-1-2.jpg')}}" alt="Brenden Legros">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{asset('../assets/img/speakers/speaker-2-2.jpg')}}" alt="Hubert Hirthe">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{asset('../assets/img/speakers/speaker-3-2.jpg')}}" alt="Cole Emmerich">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{asset('../assets/img/speakers/speaker-4-2.jpg')}}" alt="Jack Christiansen">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{asset('../assets/img/speakers/speaker-5.jpg')}}" alt="Alejandrin Littel">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{asset('../assets/img/speakers/speaker-6.jpg')}}" alt="Willow Trantow">
                </div>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{asset('../assets/img/venue-gallery/venue-gallery-1.jpg')}}" class="glightbox" data-gall="venue-gallery">
                <img src="{{asset('../assets/img/venue-gallery/venue-gallery-1.jpg')}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{asset('../assets/img/venue-gallery/venue-gallery-2.jpg')}}" class="glightbox" data-gall="venue-gallery">
                <img src="{{asset('../assets/img/venue-gallery/venue-gallery-2.jpg')}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{asset('../assets/img/venue-gallery/venue-gallery-3.jpg')}}" class="glightbox" data-gall="venue-gallery">
                <img src="{{asset(../assets/img/venue-gallery/venue-gallery-3.jpg)}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{asset('../assets/img/venue-gallery/venue-gallery-4.jpg')}}" class="glightbox" data-gall="venue-gallery">
                <img src="{{asset('../assets/img/venue-gallery/venue-gallery-4.jpg')}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{asset('../assets/img/venue-gallery/venue-gallery-5.jpg')}}" class="glightbox" data-gall="venue-gallery">
                <img src="{{asset('../assets/img/venue-gallery/venue-gallery-5.jpg')}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{asset('../assets/img/venue-gallery/venue-gallery-6.jpg')}}" class="glightbox" data-gall="venue-gallery">
                <img src="{{asset('../assets/img/venue-gallery/venue-gallery-6.jpg')}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{asset('../assets/img/venue-gallery/venue-gallery-7.jpg')}}" class="glightbox" data-gall="venue-gallery">
                <img src="{{asset('../assets/img/venue-gallery/venue-gallery-7.jpg')}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{asset('../assets/img/venue-gallery/venue-gallery-8.jpg')}}" class="glightbox" data-gall="venue-gallery">
                <img src="{{asset('../assets/img/venue-gallery/venue-gallery-8.jpg')}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card h-100">
              <div class="card-img">
                <img src="{{asset('../assets/img/hotels-1.jpg')}}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card h-100">
              <div class="card-img">
                <img src="{{asset('../assets/img/hotels-2.jpg')}}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card h-100">
              <div class="card-img">
                <img src="{{asset('../assets/img/hotels-3.jpg')}}" alt="" class="img-fluid">
              </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="{{asset('../assets/img/event-gallery/event-gallery-1.jpg')}}"><img src="{{asset('../assets/img/event-gallery/event-gallery-1.jpg')}}" class="img-fluid" alt=""></a></div>
